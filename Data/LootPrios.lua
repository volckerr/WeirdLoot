...
addon.defaultNamedItemsText = table.concat({
    "Bladebearer's Signet, paladin retribution",
    ...
    "Mimiron's Inferno Couplings, death knight blood / paladin protection / warrior protection",
    "Steamcaller's Totem, shaman restoration",
    ...
    "Heart of Iron, death knight blood",
    "Scepter of Creation, priest discipline / priest holy",
    "Dragonslayer's Brace, paladin protection / warrior protection",
    "Living Flame, Cutiedot > Lexissa",
    "Guiding Star, druid restoration",
    "Veranus' Bane, warrior protection",
    "Signet of the Earthshaker, paladin protection / warrior protection",
    ...
    "Sorthalis, Hammer of the Watchers, warrior protection",
    ...
    "Ironmender, warlock demonology / druid restoration",
    ...
    "Fate's Clutch, death knight blood / paladin protection / warrior protection",
    ...
    "Bronze Pendant of the Vanir, death knight blood / paladin protection / warrior protection",
    "Bladetwister, Rigul > Notdewbie > rogue",
    "Dreambinder, Thalamier > Owlation",
    "Titanskin Cloak, death knight blood / paladin protection / warrior protection",
    ...
    "Legplates of the Endless Void, death knight blood",
    ...
    "Bulwark of Algalon, paladin protection / warrior protection",
    "Comet's Trail, Timthedk > Rigul > LC",
    "Reply-Code Alpha, Zenkahi / Runereaver > Lueburry / Bisket / Owlation > LC",
    "Helm of the Faceless, warrior protection",
    "Libram of the Sacred Shield, paladin protection",
    "Handwraps of the Vigilant, priest discipline",
    "Vestments of the Blind Denizen, druid restoration",
    ...
    "Greaves of the Iron Army, death knight blood / paladin protection / warrior protection",
    "Starlight Treads, priest discipline",
    "Gloves of the Endless Dark, rogue combat",
    "Breastplate of the Timeless, paladin protection",
